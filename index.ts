...
const CSS_TEXT = `@keyframes ${PREFIX}FadeInDown{0%{opacity:0;transform:translate3d(-50%,-100%,0)}to{opacity:1;transform:translate3d(-50%,0,0)}}@keyframes ${PREFIX}FadeOutUp{0%{opacity:1}to{opacity:0;transform:translate3d(-50%,-100%,0)}}.${PREFIX}-fid{animation-name:${PREFIX}FadeInDown;animation-duration:.3s;animation-fill-mode:both}.${PREFIX}-fou{animation-name:${PREFIX}FadeOutUp;animation-duration:.3s;animation-fill-mode:both}.${PREFIX}-message{position:fixed;left:50%;transform:translate(-50%);padding:10px 16px;border-radius:4px;color:#fff;font-size:14px;line-height:normal;transition:top .5s ease}.${PREFIX}-message.${PREFIX}-closeable{padding:10px 32px 10px 16px}.${PREFIX}-icon{width:18px;height:18px;margin-right:8px;vertical-align:sub}.${PREFIX}-icon-close{width:16px;height:16px;margin-right:0;cursor:pointer;position:absolute;right:16px;top:50%;transform:translateY(-50%)}.${PREFIX}-message-info{color:#333;background-color:#e3e3e3}.${PREFIX}-message-warning{color:#ff9104;background-color:#ffe9cc}.${PREFIX}-message-success{color:#00c852;background-color:#c1f1d5}.${PREFIX}-message-error{color:#d32f2f;background-color:#ffd8d8}:root[data-theme=dark] .${PREFIX}-message-info{color:#999;background-color:#212121}:root[data-theme=dark] .${PREFIX}-message-warning{color:#ed8500;background-color:#3c2200}:root[data-theme=dark] .${PREFIX}-message-success{color:#00c551;background-color:#003014}:root[data-theme=dark] .${PREFIX}-message-error{color:#ef1d1d;background-color:#3b0000}`;
